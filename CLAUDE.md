...
> Status (2026-09-24): Phases 0-4 complete; Phase 5 (deploy) has both halves live with CI running but the deploy pipelines not yet switched on; Phase 6 (content & polish) and Phase 8 (polishing) in progress; Phase 7a (`githubsync`) complete behind a feature flag. `PROJECT_TODO.md` is authoritative — this line is a pointer, not a substitute.
